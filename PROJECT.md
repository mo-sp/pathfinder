...
2. **Personality / Big Five (Layer 2 – Phase 2):** 30 IPIP items. Measures Openness, Conscientiousness, Extraversion, Agreeableness, Neuroticism. Big Five **re-ranks within the RIASEC funnel** — it does not filter occupations out. Example: within a high-I/A candidate pool, an introverted + conscientious profile pushes Archivist and Data Analyst up, while an extraverted + open profile pushes Science Journalist and Museum Curator up.
