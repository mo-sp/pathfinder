...
**Not done, deliberately:** the production deploy. It is now the single action that takes the friends-beta live, and it also fixes the `www` cert as a side effect.

**Branch:** `docs/privacy-notice` (this PR).
