...
export default {
  ...
  // 17-2199.10 Wind Energy Engineers pulled out of seed (was 21124 Sprengtechnik — totally wrong domain, "explosives" instead of energy; legacy bug never caught) → title-cleanup bundle (26244 regenerative Energietechnik Anf 4, parallel zu 17-2199.03 + 17-2199.11)
  // 17-2199.11 Solar Energy Engineers pulled out of seed (was 21124 Sprengtechnik — same wrong-domain bug as .10) → title-cleanup bundle (26244 regenerative Energietechnik Anf 4)
  ...
  // === Title cleanup bundle — KldB drift fixes (2026-05-04) ===
  // Sidecar zur title-dedupe-Aufräumarbeit für 7 BACKLOG SOC-pairs:
  // (a) 13-1022 Wholesale/Retail Buyers braucht KldB-Pin (war null/unmapped) —
  // 61212 Groß-/Außenhandel Anf 2 für die Handelseinkäufer-Lesart.
  // (b) 17-2199.10 Wind + 17-2199.11 Solar Energy Engineers waren beide
  // im Seed gepinnt auf 21124 Sprengtechnik (😱 explosives, völlig falsche
  // Domain — alter Bug, nie aufgefangen) — hier korrigiert auf 26244
  // regenerative Energietechnik Anf 4 (parallel zu 17-2199.03 General
  // Energy Engineers in batch-12 block).
  "13-1022.00": { kldbCode: "61212", kldbName: "Kaufleute im Groß- und Außenhandel - fachlich ausgerichtete Tätigkeiten", anforderungsniveau: 2, trainingCategory: "apprenticeship" }, // Wholesale and Retail Buyers, Except Farm Products: war null (unmapped, no ESCO crosswalk for the Anf 2 Handels-Lesart) — Handelseinkäufer (Großhandel/Einzelhandel-Sortiment) gehört zu Kaufleute Groß-/Außenhandel; coupled mit title.de "Einkäufer/Einkäuferin" → "Einkäufer Handel/Einkäuferin Handel" (differenziert von 13-1023 Industrie-Einkäufer)
  "17-2199.10": { kldbCode: "26244", kldbName: "Berufe in der regenerativen Energietechnik - hoch komplexe Tätigkeiten", anforderungsniveau: 4, trainingCategory: "studies" }, // Wind Energy Engineers: pull-out (war 21124 Sprengtechnik 😱 — wrong-domain bug); 26244 regenerative Energietechnik parallel zu 17-2199.03 General Energy + 17-2199.11 Solar (alle drei in derselben Engineering-Familie); coupled mit title.de "Energieingenieur" → "Ingenieur Windenergie / Ingenieurin Windenergie" (differenziert von 17-2199.03 General + parallel zu 17-2199.11 "Ingenieur Solartechnik")
  "17-2199.11": { kldbCode: "26244", kldbName: "Berufe in der regenerativen Energietechnik - hoch komplexe Tätigkeiten", anforderungsniveau: 4, trainingCategory: "studies" }, // Solar Energy Systems Engineers: pull-out (war 21124 Sprengtechnik 😱 — same wrong-domain bug as .10); 26244 regenerative Energietechnik; Title bleibt "Ingenieur Solartechnik" (war bereits differenzierend)
}
