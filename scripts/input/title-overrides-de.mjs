...
export default {
  ...
  '53-1042.01': 'Recyclingkoordinator/Recyclingkoordinatorin', // Recycling Coordinators: war "Recycling-Fachkraft" (ESCO-default, aber Duplikat zu 53-7062.04 hands-on Recyclingfachkraft) — Recyclingkoordinator differenziert Anf-3-Coordinator-Tier (Programmsupervision Curbside/Drop-off) vs. Anf-2-Worker-Tier (Sortieren/Demontage); KldB 34333 Abfallwirtschaft komplex
